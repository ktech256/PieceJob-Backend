    ...
    res.status(200).json({
      ...
      data: {
        ...
        settings: {
            ...
            referralBaseUrl: settings?.referralBaseUrl || 'https://piecejob.co',
            isReferralProgramEnabled: settings?.referralProgramEnabled ?? true,
            qrBrandingType: settings?.referralQrBranding || 'PIECEJOB',
            referralRewardType: settings?.referralRewardType || 'REFERRAL_BALANCE',
            referralCurrencyCode: country.currency,
            ...
            referralFraudDuplicatePhoneEnabled: settings?.referralFraudDuplicatePhoneEnabled ?? true,
            referralFraudDuplicateEmailEnabled: settings?.referralFraudDuplicateEmailEnabled ?? true,
            referralFraudHardwareDetectionEnabled: settings?.referralFraudHardwareDetectionEnabled ?? true,
            referralFraudCircularDetectionEnabled: settings?.referralFraudCircularDetectionEnabled ?? true,
